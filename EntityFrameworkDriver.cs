namespace EntityFramework6CoreContextDriver
{
	...
	/// </summary>
	public class EntityFrameworkDriver : StaticDataContextDriver
	{
		static EntityFrameworkDriver ()
		{
		...
		public override string Name => "Entity Framework 6 .Net Core Driver";

		public override string Author => "Eric Gurney";
